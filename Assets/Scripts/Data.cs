...
public class Data {
    ...
    public static Dictionary<string, string> talentTips = new Dictionary<string, string> {
        { "剑之达人", "使用剑时单场战斗内攻击次数超过<color=#33ff33>3</color>次后不再损耗耐久" },
        { "连击", "每次己方回合时判定一次，战斗中攻击次数<color=#33ff33>+1</color>，发动率 = <color=#33ff33>技%</color>" },
        { "月光", "无视敌人<color=#33ff33>50%</color>防御力, 发动率 = <color=#33ff33>技%</color>" },
